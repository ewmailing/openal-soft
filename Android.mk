...
# The idea is that you have already built the openal .so and .a libraries using CMake.
...
# 
# This file assumes you built all your openal libs and put things into a directory structure like so:
# 
# Android.mk (this file)
# 	libs/armeabi/libopenal.a
# 	libs/armeabi/libopenal.a
# 	libs/armeabi-v7a/libopenal.a
# 	libs/armeabi-v7a/libopenal.a
# 	libs/x86/libopenal.a
# 	libs/x86/libopenal.a
# 
...
LOCAL_EXPORT_C_INCLUDES := $(LOCAL_PATH)/include/openal
...
# So let's say we put all the above in a directory called openal2D. The layout looks like this:
# openal2D/
# 	Android.mk (this file)
# 		libs/armeabi/libopenal.a
# 		libs/armeabi/libopenal.a
...
# These are the LOCAL_MODULE names as defined in the prebuilt module's Android.mk. Define either shared or static, but not both. If you use dynamic, don't forget you need to do a System.loadLibrary("openal") in your Java code.
# #LOCAL_SHARED_LIBRARIES := openal_shared
# LOCAL_STATIC_LIBRARIES := openal_static
# include $(BUILD_SHARED_LIBRARY)
# Android build system will look for folder `openal2D` in all import paths:
# $(call import-module,openal2D) 
# ------     end      -----

# Second, you need to set the environmental variable NDK_MODULE_PATH to list the directory containing openal2D.
# So if openal2D is in /Library/Frameworks/Android/PrebuiltModules
